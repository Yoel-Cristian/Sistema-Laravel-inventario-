<x-app-layout>
    <div class="container size-1/2 m-auto">
        <div class="px-4 sm:px-0">
            <h1 class="text-base font-semibold leading-7 text-gray-900">"El ID del producto es: " {{ $producto->id }}
            </h1>
        ...
        <div class="mt-6 border-t border-gray-100">
            <dl class="divide-y divide-gray-100">
                ...
                <div class="button-link"
                    ...
                    <button class="button bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded"> <a
                            href="{{ route('producto.editar', $producto) }}" class="link">Editar</a></button>
